 ...
 * EventsVenuesFixture
 */
class EventsVenuesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'events_venues_ibfk_1' => ['type' => 'foreign', 'columns' => ['event_refid'], 'references' => ['events', 'refid'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'start_date' => '2022-02-03 06:48:50',
                'end_date' => '2022-02-03 06:48:50',
