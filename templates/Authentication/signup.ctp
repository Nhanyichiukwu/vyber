    ...
    <div class="row users content">
        ...
        <div class="col-sm-6 col-sm-offset-1">
            <div class="reg-form-container"> 
                <div id="register">
                    <?= $this->Flash->render(); ?>
                        <h3>Join fellow Entataynas all over the world, and start connecting. It's free...</h3>
                        <p class="text-muted">First, let's start with your contact detail</p>

                        <!--Register Form-->
                        <?= $this->Form->create('User', ['id' => 'registration_form', 'class' => 'form-inline', 'url' => 'signup']); ?>
                        <div class="row">
                            <div class="form-group col-xs-12 col-lg-12">
                                <label for="email" class="sr-only">Email Or Phone</label>
                                <input id="contact" class="form-control input-group-lg" type="text" name="contact" title="Enter Email Or Phone" placeholder="Your Email Or Phone...">
                            </div>
                        </div>
<!--                        <div class="row">
