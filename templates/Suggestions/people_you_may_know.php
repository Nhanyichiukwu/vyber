...
<?php if (count($suggestions)): ?>
    <?php foreach ($suggestions as $someoneYouMayKnow): ?>
        <div class="someone-you-may-know d-flex card-deck gutters-xs">
            <div class="col-auto">
            ...
            <div class="col">
                <div class="account-info">
                    <p class="account-name d-b lh-1 mb-2"><?= $this->Html->link(
                            __('<strong>' . $this->Text->truncate(h($someoneYouMayKnow->getFullname()), '28', ['ellipsis' => '...']) . '</strong>'),
                            [
                                'controller' => 'e',
