...
function App(keyframes, options) {
    ...
    this.isAuthenticated = function (jqxhr = null) {
        let authenticated;
    ...
    this.ajaxLoader = {
        ...
        onContentReady: function (contentName, callback) {
     ...
     */
    this.drawer = {
        create: function (drawerID, type = 'page') {
