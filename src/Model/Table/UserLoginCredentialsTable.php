 ...
 * @method \App\Model\Entity\UserLoginCredential newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\UserLoginCredential[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\UserLoginCredential|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\UserLoginCredential|bool saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\UserLoginCredential patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\UserLoginCredential[] patchEntities($entities, array $data, array $options = [])
