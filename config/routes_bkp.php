...
//$routes->connect('/music/**', ['action' => 'display']);
//$routes->scope('/music/', ['controller' => 'Music'], function (RouteBuilder $builder) {
//    $builder->connect('/', ['action' => 'index']);
//    $builder->connect('/*', ['controller' => 'Music','action' => 'display']);
//});
...
//    }
//);
//$usernameRoutes = new UsernameRoute('/:username');
//$usernameRoutes = $usernameRoutes->setRouteClass(UsernameRoute::class);
//$usernameRoutes->connect(
//    '/:username',
//    array(
//        'controller' => 'Profiles',
//        'action' => 'view'
