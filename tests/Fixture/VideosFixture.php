...
class VideosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'videos_ibfk_4' => ['type' => 'foreign', 'columns' => ['counterpart_refid'], 'references' => ['audios', 'refid'], 'update' => 'setNull', 'delete' => 'setNull', 'length' => []],
            'videos_ibfk_3' => ['type' => 'foreign', 'columns' => ['genre_refid'], 'references' => ['genres', 'refid'], 'update' => 'setNull', 'delete' => 'setNull', 'length' => []],
            'videos_ibfk_2' => ['type' => 'foreign', 'columns' => ['album_refid'], 'references' => ['albums', 'refid'], 'update' => 'setNull', 'delete' => 'setNull', 'length' => []],
            'videos_ibfk_1' => ['type' => 'foreign', 'columns' => ['author_refid'], 'references' => ['users', 'refid'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init(): void
    {
        $this->records = [
            [
                'id' => 1,
                'refid' => 'b41a9c33-e372-4dc2-9b57-3eca1cb93b71',
                ...
                'release_date' => '2022-02-23 14:47:54',
