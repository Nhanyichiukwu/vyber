...
<body id="cw-app_profile-view" class="<?= $offcanvasState  . ' ' . $appView ?> <?= $appAccent ?> app-body off-canvas
fixed-header
h-auto"
...
<div id="app-canvas" class="app-canvas d-block w-100">
    <?= $this->element('App/off_canvas_header', ['control' => null]) ?>
        ...
        <main role="main" class="main container-fluid :only-when-on-mobile">
            <div class="row">
                <div id="pageContent" class="col-auto col-lg-11 col-main cw-profile-pad-to-fit
                flex-lg-grow-0 flex-md-fill n1ft4jmn ofjtagoh pb-5 pb-md-0 px-0">
                    <div class="l3JGmvrS vlOVOk7D qk5jrhyg">
                        <div class="_oFb7Hd h-100 px-3">
