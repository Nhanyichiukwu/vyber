...
class CategoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'type_id' => ['type' => 'biginteger', 'length' => null, 'unsigned' => true, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'categories_ibfk_2' => ['type' => 'foreign', 'columns' => ['type_id'], 'references' => ['category_types', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'categories_ibfk_1' => ['type' => 'foreign', 'columns' => ['parent_refid'], 'references' => ['categories', 'refid'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init(): void
    {
        $this->records = [
            [
                'id' => 1,
                'refid' => '34ca8e24-5e94-46ed-bc32-6e2993cdfb08',
