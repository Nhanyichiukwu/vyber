...
<?php $thisYear = date('Y'); ?>
<?php if (isset($timeline) && count($timeline)): ?>
    <?php foreach ($timeline as $year => $posts): ?>
        ...
        <div id="<?= h($year); ?>_timeline" class="e_user-timeline timeline-grid">
            <?php if ($year <= $thisYear): ?>
                ...
                <div class="flex-nowrap flex-row foa3ulpk mx-n3 n1ft4jmn ofx-auto pl-3 row tvdg2pcc">
                    <?php foreach ($posts as $post): ?>
                    <?php $postLink = $post->author->getUsername() . '/posts/'
                            . $post->refid; ?>
                        <div class="col-11 col-md-5 col-xl-5 djmlyve7">
