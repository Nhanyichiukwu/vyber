...
<div id="postComposer"
     class="post-composer content-creator bg-white composer mx-lg-auto n1ft4jmn
     ofjtagoh otgeu7ew p3n2yi2f h-100"
    ...
    n1ft4jmn q3ywbqi8 _oFb7Hd z-9">
        ...
        <button class="mmhtpn7c btn btn-azure disabled postSubmit submitBtn tsafbbqc"
            ...
            <span class="btn-text"><?= $submitVerb ?></span>
        </button>
    </div>
            ...
            <div class="d-inline-flex">
                <div class="eY tool" data-content-type="media">
                    ...
                    icon lzkw2xxp media-btn n1ft4jmn qrfe0hvl zbzlslol"
                           ...
                           aria-haspopup="false">
                        <input id="postMediaPicker" name="media" type="file" class="post-media media-uploader d-none"
