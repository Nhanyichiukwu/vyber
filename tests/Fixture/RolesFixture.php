...
class RolesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'aka' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        'description' => ['type' => 'text', 'length' => 16777215, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        'parent_id' => ['type' => 'biginteger', 'length' => null, 'unsigned' => true, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'roles_ibfk_2' => ['type' => 'foreign', 'columns' => ['industry_id'], 'references' => ['industries', 'id'], 'update' => 'setNull', 'delete' => 'setNull', 'length' => []],
            'roles_ibfk_1' => ['type' => 'foreign', 'columns' => ['parent_id'], 'references' => ['roles', 'id'], 'update' => 'setNull', 'delete' => 'setNull', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
