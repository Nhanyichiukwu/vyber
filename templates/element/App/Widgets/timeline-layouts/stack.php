...
//exit;
//if (!isset($appUser)) {
//    $appUser = $this->get('appUser');
//}
//if (!$appUser instanceof \App\Model\Entity\User) {
//    die('Can not build posts list. User not provided.');
//}
?>
...
<?php else:
    $threads = $threads->groupBy(function ($post) {
        return $post->year;
    });
    $thisYear = date('Y');
//    $threads = $this->get('threads');
    foreach ($threads as $year => $posts): ?>
        <div id="timeline_<?= h($year); ?>" class="e_user-timeline newsfeed-stack mdder6bk">
            <?php
...
//                                'clickAction' => 'render',
//                                'handler' => 'Drawer.open',
//                                'src' => '/d-cs/menu/context-menu?for=post&postid='
//                                    . $post->refid,
...
//                        );
                    ?>
                    <article id="post_<?= $randID ?>"
                             class="_aQtRd7eh _UxaA card r8upjl1q _tgqvk fx1fu3an post i__post k6xtelc6
                         mb-2 news-item p-0 post-card viewable">
                        <div class="card-body _1yT1Ry _SDyPWa p-3 _w5w has-context"
                             aria-haspopup="true" data-focusable="true"
                            ...
                            <div class="_VDKqxd">
                                <div class="clearfix d-block mb-2">
                                    <div class="XwEdci">
                                        ...
                                        <div class="giceasDh">
                                            <div class="i__pc-h _oFb7Hd">
                                                <x-cw-post-context-menu class="action-menu e-custom-dropdown dropdown
                                                _qRwCre _p5kp">
                                                    <?php
                                                    $drawerConfig = json_encode(
                                                        array(
                                                            ...
                                                            'drawerTitle' => $post->author->getFirstName() . "&apos;s post",
                                                            'dataSrc' => Router::url(
                                                                '/d-cs/menu/context-menu?for=post&postid='
                                                                . $post->refid, true
                                                            )
                                                        )
                                                    ); ?>
                                                    <a
                                                        ...
                                                        data-title='<?= $post->author->getFirstName() . "&apos;s post" ?>'
                                                        data-uri="<?= Router::url(
                                                            '/d-cs/menu/context-menu?for=post&postid='
                                                            . $post->refid, true
                                                        ) ?>"
                                                        ...
                                                        class="align-items-center box-square-2 btn-white d-flex
                                                        dropdown-toggle justify-content-center no-after rounded-circle text-center text-muted-dark"
                                                    >
                                                        <i class="mdi mdi-24px mdi-dots-vertical"></i></a>
                                                </x-cw-post-context-menu>
                                                <div class="author-info post-meta pe-5">
                                                    <div class="account-name">
                                                        <?php
                                                        /*$screenName = $post->author->getUsername();
                                                        ...
                                                        $verifiedStatus = '';
                                                        if ($post->author->isVerifiedAccount()) {
                                                            $verifiedStatus = ' account-verified';
                                                        }
                                                        ?>
                                                        <span class="account-fullname d-inline-block
                                                         h6 mb-0 pb-0<?= $verifiedStatus ?>">
                                                            <?= $this->Html->link(
                                                                __('{fullname}',
                                                                ...
                                                                [
                                                                    ...
                                                                    'data-profile-url' => $this->getRequest()
                                                                            ->getAttribute('base') . '/async/profile-card/',
                                                                    'aria-expanded' => 'true',
...
//                                    }
                                                    ...
                                                    <div class="copied-post">
                                                        <?php if ($post->isCopiedAs('quote')): ?>
                                                            ...
                                                            <div class="mt-6 fsz-16 text-right me-6">
                                                                <?= $this->Html->link(__('<span class="avatar avatar-placeholder me-3" style="background-image: url()"></span><span class="username">@{username}</span>', ['username' => $post->originalAuthor->getUsername(), 'avatar' => $post->originalAuthor->profile->getImageUrl()]),
                                        ...
                                        <?php if ($post->hasAttachments()): ?>
                                            <div class="i__pc-embedment mx-n3 mb-n3">
                                                <?= $this->PostHtml->embedAttachments($post->getAttachments()); ?>
                                            </div>
                                        <?php endif; ?>
                        ...
                        <div class="">
                            <div class="align-items-center">
                                ...
                                <div class="i__p-cta border-top _EowDPO y2j0mtlk">
                                    <div class="_isCB42C align-items-center d-flex justify-content-between px-3
                                    py-2">
                                        <div class="dropdown _8iVgvJ">
                                            <?php
                                            $state = 'no-reaction';
                                            $reactionClass = '';
                                            if (isset($appUser) && $post->hasReactionFromUser($appUser->refid)) {
                                                $state = 'reacted';
                                                            ...
                                                            <ul class="icons-list">
                                                                <li class="icons-list-item">
                                                                    <button
                                                                        ...
                                                                        data="<?= h($post->type); ?>_<?= h($post->refid); ?>_<?= h($post->author->refid); ?>_<?= h($appUser->refid); ?>"
                                                                    >
                                        ...
                                        <div class="_8iVgvJ dropdown">
                                            <button type="button" class="_8iVgvJ _KpdPyj align-items-center
                                                ...
                                                dropdown-toggle no-after" data-bs-toggle="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <div class="">
                                                    <?= $this->Form->postButton(
                                                        __('<span class="mdi mdi-18px mdi-comment-quote me-2 align-middle"></span> <span class="link-text">Quote</span>'),
                                                    ...
                                                    <?= $this->Form->postButton(
                                                        __('<span class="mdi mdi-18px mdi-account-box-multiple me-2 align-middle"></span> <span class="link-text">Own</span>'),
                                        ...
                                        <div class="_8iVgvJ dropdown">
                                            ...
                                            <div class="dropdown-menu shadow-sm">
                                                <?= $this->Form->postButton(
                                                    __('<span class="mdi mdi-18px mdi-account-arrow-left me-2 align-middle"></span> To my wall'),
                                                    [
                                                        'controller' => 'share',
                                                        'action' => 'post',
                                                        '?' => [
...
//                        The user on whose wall this post is being shared from
                                                ...
                                                <?= $this->Html->link(
                                                    __('<span class="mdi mdi-18px mdi-comment-text-multiple me-2 align-middle"></span> Share with comment'),
                                                    [
                                                        'controller' => 'share',
                                                        'action' => 'post',
                                                        '?' => [
...
//                        The user on whose wall this post is being shared from
                                                ...
                                                <?= $this->Html->link(
                                                    __('<span class="mdi mdi-message-reply-text mdi-18px me-2 align-middle"></span> Send as message'),
                                                    [
                                                        'controller' => 'share',
                                                        'action' => 'post',
                                                        '?' => [
                                ...
                                <div class="has-form i__cmnts">
                                    ...
                                    <div id="commentComposer_<?= $randID ?>" class="composer comment-composer form-container _viG" data-uri="<?= $postLink . '/comments/add_comment' ?>">
                                        <div class="HDpHu _viG">
                                            ...
                                            <div class="ms-7 ps-2 pos-r _viG">
                                                            ...
                                                            <div class="editor _VrtdFS pos-r _viG">
                                                                ...
                                                                <div class="textbox-wrapper _viG">
                                                                    <div id="<?= $randID ?>CommentTextEditor"
                                                                         class="mmhtpn7c text-editor comment-editor _Vy4 form-control fsz-16 h_I4Py h_aZ7 o-auto"
                                                            ...
                                                            <div class="d-flex gutters-0 justify-content-between">
                                                                <div class="col-auto d-inline-flex">
                                                                    <div class="eY tool" data-content-type="media">
                                                                        ...
                                                                        <div class="media-btn btn btn-icon align-items-center mmhtpn7c bgcH-grey-300 cH d-inline-flex icon justify-content-center wh_30" role="button" data-media-types="image,gif,video,audio" data-action="select-file" data-target="#e_<?= $randID ?>_commentMedia" aria-haspopup="false">
                                                                            <span aria-hidden="true"><i class="mdi mdi-18px mdi-shape-square-plus"></i></span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="eY tool" data-content-type="emoji">
                                                                        <div class="media-btn btn btn-icon align-items-center mmhtpn7c bgcH-grey-300 cH d-inline-flex icon justify-content-center wh_30" role="button" aria-haspopup="false">
                                                                    ...
                                                                    <div class="eY tool dropdown" data-content-type="options">
                                                                        <div class="media-btn btn btn-icon align-items-center mmhtpn7c bgcH-grey-300 cH d-inline-flex icon justify-content-center wh_30" role="button" data-bs-toggle="dropdown">
