<?php ?>
<div class="audio-file file-detail-form px-5">
    ...
    <div class="row mb-2">
        ...
        <div class="col-4">
            <div class="form-group">
                ...
                <div class="input-with-ajax-search">
                    <input type="text" name="playlists" placeholder="Start typing..." class="form-control">
                    <div class="ajax-search-result"></div>
                </div>
    ...
    <div class="row mb-2">
        ...
        <div class="col-3">
            <div class="form-group">
                <label class="form-label" for="content-definition">Content Classification</label>
    ...
    <div class="row">
        ...
        <div class="col-3">
            <div class="form-group">
                <label class="form-label" for="kids_inclussion">Who is this {{media}} made for?</label>
                <?php foreach (['Kids','Adults','Both'] as $index => $value): ?>
                <label class="custom-control custom-radio custom-control-inline no-before no-after">
                    <input type="radio" name="kids_inclussion" value="<?= strtolower(h($index)); ?>" class="custom-control-input">
                    <div class="custom-control-label"><?= h($value); ?></div>
                </label>
                <?php endforeach; ?>
            </div>
