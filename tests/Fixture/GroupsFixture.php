...
class GroupsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'group_image' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        'author' => ['type' => 'string', 'length' => 20, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'groups_ibfk_1' => ['type' => 'foreign', 'columns' => ['author'], 'references' => ['users', 'refid'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
