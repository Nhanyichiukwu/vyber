 ...
 *
 * @method \App\Model\Entity\EventsInvitee get($primaryKey, $options = [])
 * @method \App\Model\Entity\EventsInvitee newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\EventsInvitee[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\EventsInvitee|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\EventsInvitee|bool saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\EventsInvitee patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array
 * $options = [])
 * @method \App\Model\Entity\EventsInvitee[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\EventsInvitee findOrCreate($search, callable $callback = null, $options = [])
 */
class BkpEventsGuestsTable extends Table
{
...
//        ])->setProperty('guest');
    ...
    {
        $rules->add($rules->existsIn(['event_venue_id'], 'EventsVenues'));
