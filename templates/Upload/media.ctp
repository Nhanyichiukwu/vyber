 ...
 */
$this->set('fileType', $mediaType);
?>

<?= $this->element('upload/upload_form'); ?>
<div class="file-info-form-container" style="display: block">
    <div class="audio-file file-info-form px-5">
    <?= $this->Form->create(null, ['type' => 'file', 'id' => 'file-info-form']); ?>
        <input type="hidden" id="fileID" name="media_refid" value="">
        <div class="row gutters-xl">
            <div class="col-7">
                ...
                <div class="form-group pos-r">
                    ...
                    <p class="small text-muted">Thumbnails sends a clear message to your viewers with a clue of what your <?= $mediaType ?> is about, and also help persuade people to view/listen to it.</p>
                    <div class="form-row">
                        <div class="col-3">
            ...
            <div class="sidebar sidebar-md col-5">
                <?= $this->element('upload/file_detail_sidebar'); ?>
            </div>
        </div>
        ...
        <div class="row mb-2">
            <div class="col-12">
                <div class="section-header">
                    <h3 class="section-title">Content Attribution</h3>
                </div>
            </div>
            <div class="col-5">
                <div class="form-group">
            ...
            <div class="col-3">
                <div class="form-group">
                    ...
                    <select name="content_classification" id="content-classification" class="form-control custom-select" title="Classfication">
                        <option></option>
                        <?php foreach ($contentClassifications as $option): ?>
                            <?php if (strtolower($option) === strtolower($classification)): ?>
                        <option value="<?= strtolower($option); ?>" selected="selected"><?= ucfirst($option); ?></option>
                            <?php else: ?>
    ...
    <?php endif; ?>
        ...
        <div class="row">
            ...
            <div class="col-3">
                <div class="form-group">
                    <label class="form-label" for="target-audience">Who is this <?= $mediaType ?> made for?</label>
