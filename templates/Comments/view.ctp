...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Comment'), ['action' => 'edit', $comment->refid]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Comment'), ['action' => 'delete', $comment->refid], ['confirm' => __('Are you sure you want to delete # {0}?', $comment->refid)]) ?> </li>
...
<div class="comments view large-9 medium-8 columns content">
    ...
    <div class="row">
        ...
        <?= $this->Text->autoParagraph(h($comment->attachments)); ?>
    </div>
    <div class="row">
        <h4><?= __('Tags') ?></h4>
        <?= $this->Text->autoParagraph(h($comment->tags)); ?>
    </div>
    <div class="row">
        <h4><?= __('Location') ?></h4>
        <?= $this->Text->autoParagraph(h($comment->location)); ?>
    </div>
</div>
