...
?>
<?php $this->start('subheader'); ?>
<div class="page-header row gutters-lg justify-content-between align-items-center">
    <div class="col">
        <h2 class="page-title">
            <?= __('Videos') ?>
            <small class="page-subtitle">You have <?= count($videos) ?> videos</small>
        </h2>
    </div>
...
<?php $this->start('submenu'); ?>
    <li class="nav-item">
        <a href="<?= Router::url(['action' => 'songs']) ?>" class="nav-link">
            <i class="link-icon mdi mdi-reply"></i>
            <span class="link-text">Songs</span>
        </a>
    </li>
    <li class="nav-item">
        <a href="<?= Router::url(['action' => 'videos']) ?>" class="nav-link">
            <i class="link-icon mdi mdi-floppy"></i>
            <span class="link-text">Videos</span>
        </a>
    </li>
    <li class="nav-item">
        <a href="<?= Router::url(['action' => 'trending']) ?>" class="nav-link">
            <i class="link-icon mdi mdi-chart-line"></i>
            <span class="link-text">Trending</span>
        </a>
    </li>
    <li class="nav-item">
        <a href="<?= Router::url(['action' => 'albums']) ?>" class="nav-link">
            <i class="link-icon mdi mdi-star"></i>
            <span class="link-text">Albums</span>
        </a>
    </li>
    <li class="nav-item">
        <a href="<?= Router::url(['action' => 'lyrics']) ?>" class="nav-link">
            <i class="link-icon mdi mdi-star"></i>
