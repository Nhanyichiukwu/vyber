                ...
                <div class="carousel-inner h-100">
                    ...
                    <div id="market-stuff" class="carousel-item h-100">
                        <div class="p-6 text-center">
                            ...
                            <p>Are you a recording artist, a song writer, a vocalist, a movie star or a comedian.
                                Whatever
                                your role in entertainment industry is, we're sure you'll find a market or marketer to
                                sell
                                your work.</p>
                        </div>
                        <!--                <footer class="fixed-bottom py-3">-->
            ...
            <nav class="fixed-bottom py-3">
                <div class="container-fluid">
                    <div class="row gutters-sm">
                        <div class="col">
                            <a class="btn btn-block btn-outline-light btn-pill btn-sm prev-page text-left"
                               href="#starter"
                        ...
                        <div class="col">
                            <a class="btn btn-block btn-pill btn-sm btn-white bzakvszf n1ft4jmn next-page qrfe0hvl text-right"
                               href="#starter" role="button" data-slide="next">
