...
//            'alternative_views' => $this->UserActivities->getPopularViews($this->__getAccount())
    ...
    public function about($path = null)
    {
//        $nominations = (array) $this->UserProfiler->getUserNominations($this->__getAccount()->get('refid'));
//        $awards = (array) $this->UserProfiler->getUserAwards($this->__getAccount()->get('refid'));
//        $achievements = (array) $this->UserProfiler->getUserAchievements($this->__getAccount()->get('refid'));
//        $careerInfo = (array) $this->UserProfiler->getUserCareerInfo($this->__getAccount());
////        $awards = $this->UserActivities->getUserAwards($this->__getAccount()->get('refid'));
//
//        $this->set(compact('nominations','awards','achievements','careerInfo'));
    }

    public function connections()
    {
        $connections = (array) $this->Connections->extractActualConnectionsAsArray($this->__getAccount()->get('refid'));

        $this->set(compact('connections'));
    }

    public function events($path = null)
    {
     ...
     * @param string $path
     */
    public function photos($path = null):void
    {
...
//        Text::
    ...
    /**
     * Searches for articles where a user's name, username, or celebrity name, have been
     ...
     * @return  array|null
     */
    public function getUserRelatedArticles(\App\Model\Entity\User $user, $offset = 0, $limit = 5)
    {
        ...
        $posts = $postsTbl->find()
            ...
            ->where([
                'OR' => [
                    ...
                    ['MATCH(post_text) AGAINST(\'"@' . $user->get('username') . '"\' IN BOOLEAN MODE)']
                ]
            ])
            ->andWhere([
                'privacy' => 'public',
